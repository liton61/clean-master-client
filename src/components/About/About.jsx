        ...
        <div className='lg:w-3/4 mx-auto lg:my-20 lg:px-0 px-5'>
            <div className='lg:flex gap-10'>
                ...
                <div className='lg:w-1/2 w-full flex justify-center items-center lg:mr-0'>
                    <div>
                        <h3 className='text-xl font-medium text-green-500 uppercase lg:mt-0 mt-5'>About Us</h3>
                        ...
                        <button className="btn btn-active btn-success text-white mt-5 rounded">Read More <i className="fa-solid fa-arrow-right"></i></button>
                    </div>
                </div>
            </div>
        </div>
